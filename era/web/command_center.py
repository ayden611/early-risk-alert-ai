      ...
      return `
        <div class="monitor">
          ...
          <div class="monitor-metrics">
            ...
            <div class="metric-box"><span class="metric-k">Review Score</span><span class="metric-v">${riskText}</span></div>
          </div>
...
<script src="/static/era_command_center_score_safety.js?v=ccsafe1"></script>
</body>
</html>
"""
