...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .brand-kicker{color:#d8e4ff;font-size:11px;letter-spacing:.18em;font-weight:900;text-transform:uppercase;opacity:.9;margin-bottom:6px}
    .title{font-size:46px;font-weight:950;line-height:1;letter-spacing:-.03em;margin:0 0 8px}
    .subtitle{color:var(--muted);font-size:15px;font-weight:600}
    .live-system{
    ...
    .dot{width:10px;height:10px;border-radius:999px;background:var(--green);box-shadow:0 0 14px rgba(91,211,141,.9)}
    .hero-controls{
    ...
    .layout{display:grid;grid-template-columns:1.15fr .95fr .95fr;gap:16px}
    .section{font-size:24px;font-weight:900;letter-spacing:-.02em;margin-bottom:14px}
    ...
    .footer-note{margin-top:18px;color:#6e82a7;font-size:13px;text-align:right}
...
<body>
  <div class="shell">
    <div class="topbar">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn secondary" href="/pitch-deck.pdf">Pitch Deck PDF</a>
      </div>
    </div>
  ...
  <script>
    ...
    function applyViewMode(){
      ...
      if (currentView === "executive") model.textContent = "Executive Ops";
      else model.textContent = "Enterprise SaaS";
    }
    ...
    async function refreshStream(){
      ...
      document.getElementById("channelsBox").innerHTML =
        channels && channels.channels ? channels.channels.map(c => esc(c)).join("<br>") : '<div class="muted">No channels</div>';
    }
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .logo-kicker{font-size:11px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;color:#d8e4ff}
    .logo{font-size:32px;font-weight:950;letter-spacing:-.03em}
    ...
    .btn.secondary{background:#151f34;color:var(--text);box-shadow:none;border:1px solid var(--border)}
    .btn.outline{background:transparent;color:#dfe9ff;border:1px solid var(--border);box-shadow:none}
    ...
    .hero-kicker{color:#dce7ff;font-size:12px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;margin-bottom:16px}
    .hero-headline{font-size:78px;line-height:.94;font-weight:950;letter-spacing:-.065em;margin:0 0 18px}
    .hero-body{font-size:22px;line-height:1.45;color:#d3def2;max-width:900px}
    .hero-sub{margin-top:16px;font-size:17px;line-height:1.65;color:#a9bad8}
    .hero-actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:24px}
    .invest-highlight{font-size:34px;font-weight:950;letter-spacing:-.03em;margin:0 0 14px}
    .invest-side-text{color:#d5e1f5;font-size:18px;line-height:1.6;margin-bottom:18px}
    ...
    .micro-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:14px}
    .micro{
      border:1px solid rgba(255,255,255,.05);
      background:rgba(255,255,255,.02);
...
<body>
  <div class="shell">
    ...
    <div class="hero-grid">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          ...
          <a class="btn outline" href="/pitch-deck.pdf">Download Pitch Deck PDF</a>
        </div>
      </div>
    ...
    <div id="problem" class="section">
      ...
      <div class="grid-3">
        <div class="card"><h3>Reactive Care Models</h3><p>Many healthcare environments still depend on delayed intervention after patient risk has already escalated.</p></div>
        <div class="card"><h3>Operational Fragmentation</h3><p>Clinical teams often work across disconnected monitoring tools, scattered dashboards, and inconsistent alert workflows.</p></div>
        <div class="card"><h3>Scaling Constraints</h3><p>Hospitals face increasing patient loads, staffing shortages, and rising pressure to improve intervention speed.</p></div>
      </div>
    </div>
    ...
    <div id="revenue" class="section">
      ...
      <div class="grid-3">
        <div class="card"><h3>Enterprise Platform Licensing</h3><p>Hospitals and health systems subscribe to command-center access, monitoring dashboards, and platform infrastructure.</p></div>
        <div class="card"><h3>Per-Patient Program Revenue</h3><p>Remote monitoring and distributed care programs create scalable usage-based commercial opportunities.</p></div>
        <div class="card"><h3>Integration & Deployment Services</h3><p>Additional revenue can be generated through custom integrations, implementation support, and enterprise onboarding.</p></div>
      </div>
    </div>
    ...
    <div id="compliance" class="section">
      ...
      <div class="grid-3">
        <div class="card"><h3>HIPAA-Ready Architecture</h3><p>Designed with secure healthcare deployment principles suitable for regulated clinical environments.</p></div>
        <div class="card"><h3>Enterprise Deployment Readiness</h3><p>Built for cloud-based delivery, operational resilience, and future hospital system integration pathways.</p></div>
        <div class="card"><h3>Trust & Credibility</h3><p>Premium product presentation, live demos, and clear operating model improve institutional confidence during outreach.</p></div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="band">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:22px">
          ...
          <a class="btn secondary" href="/">Open Hospital Command Center</a>
          <a class="btn outline" href="/pitch-deck.pdf">Download Pitch Deck</a>
        </div>
      </div>
    </div>
    ...
    <div id="contact" class="section">
      ...
      <div class="contact-grid">
        ...
        <div class="contact-card">
          ...
          <div class="contact-value small">
            <a class="contact-link" href="/pitch-deck.pdf">Download Pitch Deck PDF</a>
          </div>
        </div>
        <div class="contact-card">
...
@web_bp.route("/pitch-deck", methods=["GET"])
@web_bp.route("/pitch-deck.pdf", methods=["GET"])
@web_bp.route("/download/pitch-deck", methods=["GET"])
def pitch_deck():
